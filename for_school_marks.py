school_grades = [{'school_class': '4a', 'scores': [2,4,4,5,2]},
                 {'school_class': '5b', 'scores': [4,3,5,4,4]},
                 {'school_class': '1a'}, 
                 {'school_class': '8v', 'scores': [1,4,3,4,4]}, 
                 {'school_class': '10c', 'scores': [5,2,4,3,3]}]
...
for k in school_grades:
        if 'scores' in k:
            ...
            print('{} класс оценок не имеет'.format(k['school_class']))